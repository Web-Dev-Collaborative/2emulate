...
var listSumTrace = {
  ...
  trace: [
    ...
    {
      ordered_globals: ["listSum"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { listSum: ["REF", 1] },
      heap: { 1: ["FUNCTION", "listSum(numbers)", null] },
      line: 8,
      event: "step_line",
    },
    {
      ordered_globals: ["listSum", "myList"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
        1: ["FUNCTION", "listSum(numbers)", null],
        2: ["TUPLE", 1, ["REF", 3]],
        3: ["TUPLE", 2, ["REF", 4]],
        4: ["TUPLE", 3, null],
      },
    ...
    },
    {
      ...
      stack_to_render: [
        {
          frame_id: 1,
          encoded_locals: { numbers: ["REF", 2] },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f1",
          ordered_varnames: ["numbers"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
    ...
    },
    {
      ...
      stack_to_render: [
        {
          frame_id: 1,
          encoded_locals: { numbers: ["REF", 2], rest: ["REF", 3], f: 1 },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f1",
          ordered_varnames: ["numbers", "f", "rest"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 2,
          encoded_locals: { numbers: ["REF", 3] },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f2",
          ordered_varnames: ["numbers"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 2,
          encoded_locals: { numbers: ["REF", 3], rest: ["REF", 4], f: 2 },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 3,
          encoded_locals: { numbers: ["REF", 4] },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f3",
          ordered_varnames: ["numbers"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 3,
          encoded_locals: { numbers: ["REF", 4], rest: null, f: 3 },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 4,
          encoded_locals: { numbers: null },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f4",
          ordered_varnames: ["numbers"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 4,
          encoded_locals: { __return__: 0, numbers: null },
          is_highlighted: true,
          is_parent: false,
          func_name: "listSum",
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "listSum_f4",
          ordered_varnames: ["numbers", "__return__"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        },
        {
          ...
          parent_frame_id_list: [],
          unique_hash: "listSum_f3",
          ordered_varnames: ["numbers", "f", "rest", "__return__"],
        },
      ],
      globals: { myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
    ...
    {
      ordered_globals: ["listSum", "myList", "total"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { total: 6, myList: ["REF", 2], listSum: ["REF", 1] },
      heap: {
        1: ["FUNCTION", "listSum(numbers)", null],
        2: ["TUPLE", 1, ["REF", 3]],
        3: ["TUPLE", 2, ["REF", 4]],
...
$(document).ready(function () {
  ...
  */
  ...
  allBubbles.push(
    new AnnotationBubble("variable", "v1__listSum_f1__numbers_tr")
  );
  ...
  allBubbles.push(
    new AnnotationBubble("variable", "v1__listSum_f2__numbers_tr")
  );
  ...
  allBubbles.push(
    new AnnotationBubble("variable", "v1__listSum_f3__numbers_tr")
  );
  ...
  allBubbles.push(
    new AnnotationBubble("variable", "v1__listSum_f4__numbers_tr")
  );
  allBubbles.push(
    new AnnotationBubble("variable", "v1__listSum_f4____return___tr")
  );
