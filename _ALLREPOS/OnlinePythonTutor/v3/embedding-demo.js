...
var hanoiTrace = {
  ...
  trace: [
    ...
    {
      ordered_globals: ["TowerOfHanoi"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { TowerOfHanoi: ["REF", 1] },
      heap: { 1: ["FUNCTION", "TowerOfHanoi(n, a, b, tmp)", null] },
      line: 11,
      event: "step_line",
    },
    {
      ordered_globals: ["TowerOfHanoi", "stack1"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { TowerOfHanoi: ["REF", 1], stack1: ["REF", 2] },
      heap: {
        1: ["FUNCTION", "TowerOfHanoi(n, a, b, tmp)", null],
        2: ["LIST", 4, 3, 2, 1],
      },
      line: 12,
      event: "step_line",
    ...
    {
      ordered_globals: ["TowerOfHanoi", "stack1", "stack2"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: {
    ...
    {
      ordered_globals: ["TowerOfHanoi", "stack1", "stack2", "stack3"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: {
      ...
      stack_to_render: [
        {
          ...
          is_zombie: false,
          parent_frame_id_list: [],
          unique_hash: "TowerOfHanoi_f1",
          ordered_varnames: ["n", "a", "b", "tmp"],
        },
      ],
      globals: {
        stack3: ["REF", 4],
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        },
        {
          ...
          parent_frame_id_list: [],
          unique_hash: "TowerOfHanoi_f4",
          ordered_varnames: ["n", "a", "b", "tmp", "__return__"],
        },
      ],
      globals: {
        stack3: ["REF", 4],
...
var happyTrace = {
  code: '# From "Teaching with Python" by John Zelle\ndef happy():\n    print("Happy Birthday to you!")\n\ndef sing(P):\n    happy()\n    happy()\n    print("Happy Birthday dear " + P + "!")\n    happy()\n\n# main\nsing("Fred")\n',
  trace: [
    {
      ordered_globals: [],
      stdout: "",
    ...
    {
      ordered_globals: ["happy"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { happy: ["REF", 1] },
      heap: { 1: ["FUNCTION", "happy()", null] },
      line: 5,
      event: "step_line",
    },
    {
      ordered_globals: ["happy", "sing"],
      stdout: "",
      func_name: "<module>",
      stack_to_render: [],
      globals: { sing: ["REF", 2], happy: ["REF", 1] },
      heap: {
        1: ["FUNCTION", "happy()", null],
        2: ["FUNCTION", "sing(P)", null],
      },
      line: 12,
      event: "step_line",
    },
    ...
    },
    {
      ...
      stack_to_render: [
        ...
        {
          frame_id: 2,
          encoded_locals: { __return__: null },
          is_highlighted: true,
          is_parent: false,
          func_name: "happy",
          is_zombie: false,
    ...
    },
    {
      ...
      stack_to_render: [
        {
          frame_id: 1,
          encoded_locals: { __return__: null, P: "Fred" },
          is_highlighted: true,
          is_parent: false,
          func_name: "sing",
          is_zombie: false,
